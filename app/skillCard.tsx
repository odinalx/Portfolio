    ...
    <div className="flex flex-wrap justify-center w-full gap-10">
      {items.map((item, idx) => {
        ...
        return (
          <div
            key={idx}
            className="group w-1/5 h-80 border border-primary rounded flex flex-col justify-between items-start hover:bg-secondary hover:text-black hover:border-secondary transition-all duration-200 ease-in-out transform hover:scale-105"
          >
